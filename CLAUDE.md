...
3. Add `compile_sql()` assertions for **PostgreSQL and DuckDB** at minimum
...
| 4 | Docs (current stable) | `website/versioned_docs/version-0.4/` |
...
- `website/versioned_docs/version-0.4/` — current stable
- `website/versioned_docs/version-0.3/` — previous version (different syntax)

Rules:
- **Never backport v0.4+ features into v0.3 docs.** v0.3 has different syntax and conventions (e.g. `MESSAGE JOURNEY` is valid in v0.3 but removed in v0.4.1).
