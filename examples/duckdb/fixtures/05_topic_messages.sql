...
INSERT INTO topic_messages (robot_id, topic_name, timestamp, trace_id, fields, message_type) VALUES
('robot-amr-02', '/odom', NOW()::TIMESTAMP - INTERVAL '26 minutes',
 'trace-amr02-m3',
 '{"pose.pose.position.x": "0.0", "pose.pose.position.y": "0.0", "orientation.z": "0.4"}',
 'nav_msgs/msg/Odometry'),
('robot-amr-02', '/odom', NOW()::TIMESTAMP - INTERVAL '26 minutes' + INTERVAL '2 seconds',
 'trace-amr02-m3',
 '{"pose.pose.position.x": "0.9", "pose.pose.position.y": "0.5", "orientation.z": "0.42"}',
 'nav_msgs/msg/Odometry'),
('robot-amr-02', '/odom', NOW()::TIMESTAMP - INTERVAL '26 minutes' + INTERVAL '4 seconds',
 'trace-amr02-m3',
