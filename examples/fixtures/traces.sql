...
-- ParentSpanId links create the causality chain for MESSAGE JOURNEY queries.

-- ============================================================================
-- Action 1: SUCCESS — waypoint A (10:00:00 – 10:08:00)
-- ============================================================================

-- Root span: /navigate_to_pose
INSERT INTO otel_traces ("Timestamp", "TraceId", "SpanId", "ParentSpanId", "SpanName", "ServiceName", "Duration", "StatusCode", "SpanAttributes") VALUES
...
-- Root span: /navigate_to_pose — ERROR
INSERT INTO otel_traces ("Timestamp", "TraceId", "SpanId", "ParentSpanId", "SpanName", "ServiceName", "Duration", "StatusCode", "SpanAttributes") VALUES
...
-- Root span: /navigate_to_pose — ERROR (timeout)
INSERT INTO otel_traces ("Timestamp", "TraceId", "SpanId", "ParentSpanId", "SpanName", "ServiceName", "Duration", "StatusCode", "SpanAttributes") VALUES
