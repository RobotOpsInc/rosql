-- Fixture: otel_metrics — topic rates, CPU, memory, battery metrics
--
-- Timeline:
--   10:00-10:08  Action 1 (success) — normal metrics
--   10:09-10:21  Action 2 (abort)   — CPU spike, topic rate drop
--   10:25-10:55  Action 3 (timeout) — normal metrics

-- ============================================================================
-- /cmd_vel topic publish rate (Hz) — normally 10 Hz, drops during failures
-- ============================================================================

INSERT INTO otel_metrics ("Timestamp", "MetricName", "Value", "Attributes", "ServiceName") VALUES
-- Action 1: stable 10 Hz
