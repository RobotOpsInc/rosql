...
Relative tokens: `X minutes ago`, `X hours ago`, `X days ago`, `yesterday`

Event-relative tokens: `last deployment`, `last robot restart`, `last action failure`, `last topic drop`, `last diagnostic warning`
