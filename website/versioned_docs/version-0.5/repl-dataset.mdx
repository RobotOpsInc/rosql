...
The raw SQL that builds this dataset is in [`website/static/fixtures/`](https://github.com/RobotOpsInc/rosql/tree/main/website/static/fixtures) — eight files loaded sequentially into an in-browser DuckDB instance each time you open the REPL.
