...
DuckDB runs embedded and reads Parquet files directly — no external server required.
...
- **Local telemetry replay** — query Parquet exports from the demo-agent or OTel Collector without standing up a database
