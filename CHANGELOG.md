...
- **schema-reference** (v0.4) — added full 29-entry metric field alias table from `otel_registry`; added `tf_states`, `robot_heartbeats`, `system_logs`, `ros2_events` table schemas
